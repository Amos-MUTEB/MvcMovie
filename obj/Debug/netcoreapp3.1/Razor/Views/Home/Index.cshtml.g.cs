#pragma checksum "C:\Users\amosm\source\repos\MvcMovie\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c6867cb8f4b2509f8e4965142c76a634a84c70d0"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c6867cb8f4b2509f8e4965142c76a634a84c70d0", @"/Views/Home/Index.cshtml")]
...
<div>
    ...
    gitignore de base pour .NET Core :
        ...
        <li class=""nav-item"">
            <div><s>4 Supprimer du menu les pages de bases pour 2 liens de menu fonctionnels vers les pages vides suivante");
            WriteLiteral(@"s : ""Accueil"", ""Liste des stations"", ""Carte"", ""Mes favoris""</s></div>
        </li>
        <li class=""nav-item"">
    ...
    Razor Cheat sheet
        ...
        <li class=""nav-item"">
            <div><s>
    8 Afficher les données de l'API sous forme de carte sur la page ""Carte"" (chaque station sera représent");
            WriteLiteral(@"ée par une épingle à son emplacement)
    ...
    12 Compléter la page ""Mes favoris"" pour n'afficher sous forme de tableau que les stations marquées en favoris
        ...
        <li class=""nav-item"">
            <div>
                13 Stocker les stations f");
            WriteLiteral(@"avorites dans une base SQL
